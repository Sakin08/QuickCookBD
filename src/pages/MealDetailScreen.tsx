  ...
  return (
    <div className="h-[calc(100vh-76px)] overflow-y-auto">
      <div className="max-w-5xl mx-auto px-4 py-6">
        <button
          onClick={onBack}
          className="group mb-4 flex items-center gap-2 px-4 py-2 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all font-semibold text-gray-600 hover:text-orange-600 text-sm"
        >
